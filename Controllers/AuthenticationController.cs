...
public class AuthenticationController : Controller
{
	...
	public async Task<IActionResult> Login(LoginVM loginVM)
	{
		...
		if (await _userManager.IsInRoleAsync(appUser, Roles.SuperAdmin.ToString()) || await _userManager.IsInRoleAsync(appUser, Roles.SuperAdmin.ToString()))
		{
